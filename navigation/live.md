...
<div class="row mx-3 mb-4 rounded-3 align-items-md-stretch" style="height: 100vh; width: 100%; overflow: auto;">
    ...
    <script>
        ...
        const cars = [
            ...
            { name: "San Diego Air & Space Museum", price: "$22.50", location: "2001 Pan American Plaza, San Diego, CA 92101", info: "{{site.baseurl}}/airspace" },
            { name: "Gaslamp Quarter", price: "Free", location: "San Diego, CA 92101", info: "{{site.baseurl}}/gaslamp" },
            { name: "Seaport Village", price: "Free", location: "849 W Harbor Dr, San Diego, CA 92101", info: "{{site.baseurl}}/seaport" },
